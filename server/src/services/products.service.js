...
const update_product = async (productId, productData) => {
  const updateData = Object.fromEntries(Object.entries(productData).filter(([_, value]) => value !== null));
  return await Products.findByIdAndUpdate(productId, updateData, { returnDocument: "after" });
}
...
export default { get_all_products, add_product, update_product, delete_product, validate_product_input, validate_product_update_input };