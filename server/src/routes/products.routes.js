...
router.post('/', auth_middleware.verify_token("ADMIN"), upload.uploadImage, products_controller.add_product);
router.put('/:id', auth_middleware.verify_token("ADMIN"),  upload.uploadImage, products_controller.update_product);
